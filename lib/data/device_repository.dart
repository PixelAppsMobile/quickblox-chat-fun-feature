...
class DeviceRepository {
  ...
  final Set<ConnectionListener> _connectionListenersSet =
      HashSet<ConnectionListener>();
  ...
  void _notifyListeners(ConnectionType type) {
    for (var element in _connectionListenersSet) {
...
class ConnectionListener {
  ...
  bool operator ==(Object other) {
    return other is ConnectionListener &&
